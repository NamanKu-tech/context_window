...
_GENERAL = (
    ...
    _m("general", "sam", "Leadership sent the monthly materials this morning. Thanks everyone."),
    ...
    _m("general", "rahul", "Design keeps asking whether the product roadmap is firm."),
